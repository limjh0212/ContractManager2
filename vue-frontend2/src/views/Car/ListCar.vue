    ...
    <div align="center">
        ...
        <div style="margin:30px; width:  1100px; ">
            <div align="left" style="margin: 30px">
                <v-btn v-if="isAdmin('admin')" elevation="2" style="text-decoration: none; ">
                    <router-link style="text-decoration: none; color: black" to="/car/write/">신규 작성</router-link>
                </v-btn>
            </div>
...
<script>
import {api_carList} from "@/api/api_car";
    ...
    data() {
        return {
            ...
            headers     : [{text: 'No', value: 'id', align: 'center'},
                ...
                {text: '차량', value: 'object', align: 'center'},
                {text: '차량번호', value: 'carnum', align: 'center'},
                {text: '사용자', value: 'caruser', align: 'center'},
                {text: '계약시작일', value: 'startdate', align: 'center'},
                {text: '계약종료일', value: 'enddate', align: 'center'},
                {text: '비용', value: 'monthlyfee', align: 'end'},
                {text: '업체명', value: 'client', align: 'center'},
                {text: '전화번호', value: 'clientnumber', align: 'center'}],
