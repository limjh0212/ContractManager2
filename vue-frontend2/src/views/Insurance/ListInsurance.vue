        ...
        <div style="margin:30px; width: 1100px; ">
            <div align="left" style="margin: 30px">
                <v-btn v-if="isAdmin('admin')" elevation="2" style="text-decoration: none; ">
                    <router-link style="text-decoration: none; color: black" to="/insurance/write/">신규 작성</router-link>
                </v-btn>
            </div>
...
<script>
import {api_insuranceList} from "@/api/api_insurance";
    ...
    data() {
        return {
            ...
            headers     : [{text: 'No', value: 'id', align: 'center'},
                ...
                {text: '비용', value: 'cost', align: 'end'},
                {text: '보험사', value: 'client', align: 'center'},
...
//                {text: '계약서', value: 'files', align: 'center'}],
    ...
    methods: {
        ...
        async FETCH_DATA() {
            const {data} = await api_insuranceList();
            this.list = data;
            this.loading = false;
        },
